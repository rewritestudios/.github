...
Rewrite is committed to providing an **open, welcoming, safe, and respectful environment** for everyone who participates in our open-source ecosystem.
...
This Code of Conduct applies to **all Rewrite open-source repositories**, including:
- all repositories under the Rewrite GitHub organization
...
- permanent removal from Rewrite projects
